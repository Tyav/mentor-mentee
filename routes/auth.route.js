...
router
  ...
  .post(validate(authValidation.forgotPassword, { abortEarly: false }), authCtrl.forgotPassword);
...
router
  ...
  .post(validate(authValidation.resetPassword, { abortEarly: false }), authCtrl.resetPassword);
router
  .route('/change-password')
  .put(validate(authValidation.changePassword, { abortEarly: false }), authCtrl.changePassword);
